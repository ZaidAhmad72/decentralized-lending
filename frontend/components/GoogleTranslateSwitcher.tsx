...
const LANGUAGES = [
  { code: "en", label: "English",  flag: "≡ƒç║≡ƒç╕" },
  { code: "hi", label: "αñ╣αñ┐αñ¿αÑìαñªαÑÇ",    flag: "≡ƒç«≡ƒç│" },
  { code: "mr", label: "αñ«αñ░αñ╛αñáαÑÇ",     flag: "≡ƒç«≡ƒç│" },
  { code: "ta", label: "α«ñα««α«┐α«┤α»ì",     flag: "≡ƒç«≡ƒç│" },
  { code: "te", label: "α░ñα▒åα░▓α▒üα░ùα▒ü",    flag: "≡ƒç«≡ƒç│" },
  { code: "kn", label: "α▓òα▓¿α│ìα▓¿α▓í",     flag: "≡ƒç«≡ƒç│" },
  { code: "gu", label: "α¬ùα½üα¬£α¬░α¬╛α¬ñα½Ç",   flag: "≡ƒç«≡ƒç│" },
];
