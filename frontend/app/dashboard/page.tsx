      ...
      <div className="px-5">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-[#e5e9f0] mb-4">
          ...
          <p className="text-center text-sm text-[#6b7280]">
            Your institutional credit score is in the top 2% of global lenders.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-[#e5e9f0]">
          {activity.map((item, i) => (
            ...
            >
              <div className="w-10 h-10 bg-[#f3f4f6] rounded-xl flex items-center justify-center text-lg">
                {item.icon}
              </div>
              ...
              <span className={`font-bold text-sm ${item.positive ? "text-[#16a34a]" : "text-red-500"}`}>
                {item.value}
              </span>
            </div>
          ))}
