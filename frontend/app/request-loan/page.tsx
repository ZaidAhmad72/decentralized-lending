  ...
  return (
    <div className="min-h-screen bg-[#eef2f7] pb-24">
      ...
      <div className="px-5">
        ...
        {/* Form */}
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-[#e5e9f0] mb-5 flex flex-col gap-5">
          {/* Loan Amount */}
          <div>
        ...
        <button
          ...
          disabled={submitted}
          className="w-full bg-[#1a2fb8] text-white rounded-2xl py-5 font-bold text-lg flex items-center justify-center gap-3 hover:bg-[#1527a0] transition-all active:scale-95 mb-6 disabled:opacity-70"
        >
        ...
        {/* Eligibility Card */}
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-[#e5e9f0] flex flex-col items-center text-center">
